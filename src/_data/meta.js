...
export const author = {
  name: 'Nikhil Patel', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'hello@crit-lit.com' // i.e. hola@lenesaile.com - email of the author
};
export const creator = {
  name: 'Nikhil Patel', // i.e. Lene Saile - creator's (developer) name.
  email: 'hello@crit-lit.com'
};
export const pathToSvgLogo = 'src/assets/svg/misc/logo.svg'; // used for favicon generation
export const themeColor = '#5f5880'; // used in manifest, for example primary color value
